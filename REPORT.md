...
**Academic Year**: 2026  
**Implementation Mode**: Terminal / Command-Line Interface (CLI) & Localhost Web Dashboard  
...
|      DoctorMenu, PatientMenu, ConsoleUtil, LocalHostServer) |
+-------------------------------------------------------------+
                              |
                              v
+-------------------------------------------------------------+
...
graph TD
    subgraph Presentation_Layer ["Presentation Layer (CLI & Web)"]
        ...
        DocMenu["DoctorMenu"]
        PatMenu["PatientMenu"]
        LocalHost["LocalHostServer (port 8080)"]
    ...
    LocalHost --> PatientService & DoctorService & AppointmentService & BillingService & ReportService & AuditService
...
The project contains 29 dedicated Core Java source files organized into logical packages:
...
- `com.hms.ui`: Role-based console menu controllers (`AdminMenu`, `ReceptionistMenu`, `DoctorMenu`, `PatientMenu`, and `LocalHostServer`).
...
- **[Insert Screenshot 8: Localhost Web Dashboard on http://localhost:8080]**  
  *Browser view of the real-time KPI cards and outpatient directory.*
